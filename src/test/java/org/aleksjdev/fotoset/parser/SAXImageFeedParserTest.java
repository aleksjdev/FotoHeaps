...
import org.aleksjdev.fotoset.parser.impl.SAXImageFeedParser;
...
/**
 * Тестирования SAX парсера для разбора содержимого ответа от сервера Yandex.Fotki
 */
public class SAXImageFeedParserTest {

    private ImageFeedParser parser;

    @Before
    public void setUp() {
        parser = new SAXImageFeedParser();
    }
